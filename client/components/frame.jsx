...
this.state = {
    ...
    return (
    <div className="frame">
    <div className="calculator-title" style={{color:'red',alignItems:'center',fontWeight: 'bold',
    paddingLeft:'300px',
fontSize:'20px',}}>
    R_N Calculator
    </div>
    <Screen   question={this.state.question}  style={{paddingLeft:'300px'}}
...
handleClick(event){
const value = event.target.value; // get the value from thevtarget element (button)
switch (value) {
